...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
    ...
    [_LOWER] =  { ENCODER_CCW_CW(KC_NO, KC_NO),           ENCODER_CCW_CW(KC_NO, KC_NO)  },
    [_RAISE] =  { ENCODER_CCW_CW(KC_NO, KC_NO),           ENCODER_CCW_CW(KC_NO, KC_NO)  },
    [_ADJUST] = { ENCODER_CCW_CW(KC_NO, KC_NO),          ENCODER_CCW_CW(KC_NO, KC_NO) },
};
#endif