...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
          ...
          KC_CAPS,   KC_A,     KC_S,    KC_D,   KC_F,   KC_G,   KC_NO,                KC_NO,   KC_H,   KC_J,    KC_K,     KC_L,    KC_KC_SCLN,  KC_ENT,
          KC_LSFT,   KC_Z,     KC_X,    KC_C,   KC_V,   KC_B,   KC_NO,                KC_NO,   KC_N,   KC_M,    KC_COMM,  KC_DOT,  KC_SLSH,     KC_RSFT,  
          KC_LCTL,   KC_LWIN,  KC_NO,   KC_NO,  KC_NO,  KC_NO,  KC_NO,                KC_NO,   KC_NO,  KC_NO,   KC_RGHT,  KC_UP,   KC_DOWN,     KC_LEFT
    )
};
